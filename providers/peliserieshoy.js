...
function V(e, t, n, r) {
  return m(this, null, function* () {
    ...
    try {
      ...
      return console.error(`[PelisSeriesHoy] Error: ${i.message}`), [{ name: `[PelisSeriesHoy] Error: ${i.message}`, title: String((i && i.stack) || (i && i.message) || i).slice(0, 300), url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4" }];
    }
  });
}
